...
import com.yuruicai.test.common.easyexcel.model.WriteModel2;
import com.yuruicai.test.common.easyexcel.util.DataUtil;
...
public class ExcelTests {
     ...
     */
    @Test
    public void writeExcel1(HttpServletResponse response , String path , String  sheetName , List<? extends BaseRowModel> data , Class<? extends BaseRowModel> clazz) throws Exception {
        // 文件输出位置
...
// 关闭流
    ...
    public void writeExcel2() throws Exception {
        // 文件输出位置
        OutputStream out = new FileOutputStream("F:\\aa\\test1.xlsx");
...
//        table1.setTableStyle(DataUtil.createTableStyle());
    ...
    public void writeExcelSimple() throws Exception {
        OutputStream out = new FileOutputStream("F:\\aa\\test3.xlsx");
        ExcelWriter writer = EasyExcelFactory.getWriter(out);
        // ==================================== Start ====================================
    ...
    public void writeChongqingExcel() throws Exception {
        OutputStream out = new FileOutputStream("F:\\aa\\test4.xlsx");
        ExcelWriter writer = EasyExcelFactory.getWriter(out);
