package com.yuruicai.test.resfull.config;
...
@EnableJpaRepositories(basePackages = "com.yuruicai.test.resfull.dao")//启动JPA资源库并设置接口资源库的位置
@EntityScan(basePackages = "com.yuruicai.test.resfull.domin")//实体类位置
