...
@EnableJpaRepositories(basePackages = "com.yuruicai.test.server.springcloud.dao")//启动JPA资源库并设置接口资源库的位置
@EntityScan(basePackages = "com.yuruicai.test.server.springcloud.domain")//实体类位置
